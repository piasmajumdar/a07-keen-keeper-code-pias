        ...
        <div className='bg-[#244D3F] pt-20 pb-8 text-center'>
            <div className='w-11/12 max-w-[1110px] mx-auto space-y-10'>
                <div className='space-y-4'>
                    <h2 className='text-3xl md:text-5xl text-white font-bold'>KeenKeeper</h2>
                ...
                <div className='text-white/50 flex  flex-wrap sm:flex-nowrap gap-2 justify-center sm:justify-between pt-8 border-t border-t-[#1A8862]/50'>
